// https://github.com/getify/You-Dont-Know-JS/tree/1st-ed/up%20%26%20going
// https://raw.githubusercontent.com/getify/You-Dont-Know-JS/1st-ed/up%20%26%20going/README.md
var RAW_REPO_BASE_URL = 'https://raw.githubusercontent.com/getify/You-Dont-Know-JS/1st-ed/';
//var REPO_FILES_URL = 'https://api.github.com/repos/getify/You-Dont-Know-JS/contents';
var REPO_FILES_URL = 'https://api.github.com/repos/getify/You-Dont-Know-JS/contents'; 
var BRANCH_SUFFIX = '?ref=1st-ed' 
...
// UN/COMMENT TO IMMEDIATELY LOAD THE FIRST BOOK'S README.MD
...
function requestBookfolder(encodeBookName) {
    axios.get(REPO_FILES_URL + '/' + encodeBookName + BRANCH_SUFFIX)
        .then(function (response) {
            ...
            console.log('files found img and md:', imageFileNames.length, markdownFiles.length);
...
function injectImageUrlsIntoHtml(html, encodeBookName) {
    for (var j = 0; j < imageFileNames.length; j++) {
        var rawImageUrl = RAW_REPO_BASE_URL + encodeBookName + '/' + imageFileNames[j];
...
function sortMarkdownFilesByOccurence(html) {
    ...
    return indexedMdFiles.sort(function (currElem, nextElem) {
